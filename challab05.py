[200~#!/usr/bin/env python3
        ...
        if char_name == "flash" and char_stat == speed:
           message = char_name + 's ' + char_stat + 'is: ' +  info["flash"]["speed"]
              
           elif char_name == "flash" and char_stat == intelligence:
              message = char_name + 's ' + char_stat + 'is: ' +  info["flash"]["intelligence"]

              elif char_name == "flash" and char_stat == strength:
                 message = char_name + 's ' + char_stat + 'is: ' +  info["flash"]["strength"]
